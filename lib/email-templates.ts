  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e5e7eb; border-radius: 8px;">
      ...
      <div style="background-color: #f3f4f6; padding: 15px; border-radius: 6px; margin: 20px 0;">
        <p style="margin: 5px 0;"><strong>Start Time:</strong> ${dayjs(startTime).format('MMMM D, YYYY h:mm A')}</p>
        <p style="margin: 5px 0;"><strong>End Time:</strong> ${dayjs(endTime).format('MMMM D, YYYY h:mm A')}</p>
      </div>
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e5e7eb; border-radius: 8px;">
      ...
      <div style="background-color: #f3f4f6; padding: 15px; border-radius: 6px; margin: 20px 0; text-align: center;">
        <h3 style="margin: 0; color: #111827;">${dayjs(startTime).format('h:mm A')}</h3>
